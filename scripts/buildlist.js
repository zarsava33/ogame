function ReBuildView() {
        ...
        $.each(data.build, function(index, val) {
                if (index == 0) {
					    ...
					    HTML    += '<img class="tooltip" name="'+val.name+'" src="styles/theme/'+data.raza_skin+'/gebaeude/'+val.element+'.png" width="40" height="40" /><span class="encola_c">'+data.nivel+' '+val.level+'</span> '+val.mode+' ';
