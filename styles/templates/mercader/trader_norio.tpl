				...
				<tr class="alt_2">
					...
					<div class="bg_input"><input name="metal" class="text" id="metal" type="text" value="0" onkeyup="calcul('{$ress}')" style="text-align: right;" /></div>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip" name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Metal}</b></span> = {$mod_ma_res_a} {$Norio}">{$mod_ma_res_a}</span>
						</td>
    			</tr>	
				<!-- Cristal -->
				<tr class="alt_2">
					...
					<div class="bg_input"><input name="crystal" class="text" id="crystal" type="text" value="0" onkeyup="calcul('{$ress}')" style="text-align: right;" /></div>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip" name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Crystal}</b></span> = {$mod_ma_res_b} {$Norio}">{$mod_ma_res_b}</span>
						</td>
    			</tr>
				<!-- Deuterio -->
				<tr class="alt_2">
					...
					<td class="noCenter">{$Deuterium}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip"  name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Deuterium}</b></span> = {$mod_ma_res_c} {$Norio}">{$mod_ma_res_c}</span>
						</td>
				</tr>
				<!-- Norio -->
				<tr class="alt">
