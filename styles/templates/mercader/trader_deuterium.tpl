			...
			<tbody><tr>
				...
				<tr class="alt_2">
					...
					<td class="noCenter">{$Metal}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip"  name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Metal}</b></span> = {$mod_ma_res_a} {$Deuterium}">{$mod_ma_res_a}</span>
						</td>
				</tr>
				<!-- Cristal -->
				<tr class="alt_2">
				...
				<tr class="alt_2">
					...
					<td class="noCenter">{$Norio}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip" name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Norio}</b></span> = {$mod_ma_res_d} {$Deuterium}">{$mod_ma_res_d}</span>
						</td>
				</tr>
				<!-- Otras cosas -->
				<tr>
