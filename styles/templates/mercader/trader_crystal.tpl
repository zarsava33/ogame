			...
			<tbody><tr>
				...
				<tr class="alt_2">
					...
					<td class="noCenter">{$Deuterium}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip"  name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Deuterium}</b></span> = {$mod_ma_res_b} {$Crystal}">{$mod_ma_res_b}</span>
						</td>
				</tr>
				<!-- Norio -->
				<tr class="alt_2">
					...
					<td class="noCenter">{$Norio}</td>
						...
						<td class="rate tipsTitle">
                            <span class="marca_color tooltip" name="<h2>{$tr_quota_exchange}:</h4><span class='marca_color'><b>1 {$Norio}</b></span> = {$mod_ma_res_d} {$Crystal}">{$mod_ma_res_d}</span>
						</td>
				</tr>
				<!-- Otras cosas -->
				<tr>
