...
<form name="message" id="message" action="">
	...
	<tr>
        ...
        <td class="transparent"><input class="campo_comun" type="text" name="to" size="40" value="{$username} [{$galaxy}:{$system}:{$planet}]"></td>
    </tr><tr>
        <td class="transparent">{$mg_subject}</td>
        <td class="transparent"><input class="campo_comun" type="text" name="subject" id="subject" size="40" maxlength="40" value="{$subject}"></td>
    </tr><tr>
